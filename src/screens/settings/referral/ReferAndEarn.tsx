...
const ReferAndEarnScreen = () =>
	// props: ReferralProgramNativeStackScreenProps<"ReferAndEarn">,
	{
		const navigation =
			useNavigation<
		...
		const handlePressAnalytics = () => router.push("/referrals/analytics");
		...
		const handlePressReferralDashboard = () =>
		...
		return (
			<FansScreen3 contentStyle={tw.style("p-[0px]")}>
				<FansView
					width="full"
					height={{ xs: 395, lg: 355 }}
					backgroundColor="purple-5f"
					position="absolute"
				/>
				<FansView
					style={tw.style("max-w-[707px]")}
					alignSelf="center"
					padding={{ x: 17 }}
				>
					<FansGap height={{ xs: 26.8, lg: 30.3 }} />
					<FansView alignItems="center">
						<UserAvatar size="95px" />
						<FansGap height={{ xs: 21.8, lg: 17.8 }} />
						<FansView
							style={tw.style("max-w-[204px] lg:max-w-full")}
						>
							<FansText
								color="white"
						...
						<FansView style={tw.style("max-w-[319px]")}>
							<FansText
								...
								textAlign="center"
							>
								Earn an industry-leading lifetime share of 20%
								on all subscriptions and paid posts
							</FansText>
						</FansView>
					</FansView>

					<FansGap height={{ xs: 35.7, lg: 37.6 }} />

					{/* Your referral link ~ */}
					<FansView
						height={{ xs: 190, lg: 169 }}
						style={tw.style(
					...
					>
						...
						<FansGap height={12} />
						<FansView
							style={tw.style("max-w-[218px] lg:max-w-none")}
						>
							<FansText fontSize={16} textAlign="center">
								Starting referring fans today, and see your
								earnings soar
							</FansText>
						</FansView>
						<FansGap height={20} />
					...
					<FansGap height={{ xs: 31, lg: 47 }} />

					{/* Share your link ~ */}
					<FansView style={tw.style("flex items-center")} gap={18}>
					...
					{/* ~ Share your link */}
					<FansGap height={{ xs: 36, lg: 53 }} />
					<FansHorizontalDivider />
					<FansGap height={{ xs: 31, lg: 48 }} />
					...
					<FansView gap={12}>
						...
						<FansText color="grey-70" fontSize={16}>
							To manage payouts and view detailed analytics, go to
							your{" "}
							{tw.prefixMatch("lg") ? (
								<FansView>
									<FansText
					...
					{!tw.prefixMatch("lg") && (
						<Fragment>
							...
							<RoundButton
								...
								onPress={handlePressReferralDashboard}
							>
								<FansView
									style={tw.style(
					...
					>
						...
						<FansView alignItems="center">
							...
							<FansGap height={12} />
							<FansView maxWidth={218}>
								<FansText
									color="white"
									fontSize={16}
									textAlign="center"
								>
									Start referring fans today, and see your
									earnings soar
								</FansText>
							</FansView>
							<FansGap height={20} />
						...
						<FansText
							...
							fontFamily="inter-semibold"
							fontSize={17}
							style={tw.style("text-center mt-[26px]")}
						>
							Share your link
						</FansText>
						<FansView
							style={tw.style(
								"mt-[18px] flex-row items-center justify-center gap-[25px]",
							)}
						>
							{socials.map((item, index) => (
								<FansView
								...
								>
									{item.icon}
									<FansText color="white" fontSize={14}>
										{item.title}
									</FansText>
								</FansView>
							))}
